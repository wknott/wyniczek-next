...
export type GameSortBy = "ALPHABETICAL" | "LAST_PLAYED" | "POPULARITY";
...
export type GameCardDataFragment = {
	id: string;
	name: string;
	thumbnailUrl?: string | null;
	latestResult?: {
		createdAt: unknown;
		scores?: Array<{ player?: { name: string; id: string } | null }> | null;
	} | null;
};
...
export type GetGamesForInfiniteScrollQuery = {
	games: {
		total: number;
		items: Array<{
			id: string;
...
export type GetGamesForScoringQuery = {
	games: {
		items: Array<{
			id: string;
			name: string;
			...
			minPlayers: number;
			maxPlayers: number;
			pointCategories?: Array<{ id: string; name: string }> | null;
		}>;
	};
};
...
export type ResultsGetListQuery = {
	results: {
		total: number;
		items: Array<{
			id: string;
			createdAt: unknown;
			playingTime?: number | null;
			game: { name: string; thumbnailUrl?: string | null };
			scores?: Array<{
				player?: { name: string } | null;
				points?: Array<{ value?: number | null }> | null;
			}> | null;
		}>;
	};
};
...
export const GameCardDataFragmentDoc = new TypedDocumentString(
  ...
  latestResult {
    ...
    `,
	{ fragmentName: "GameCardData" },
) as unknown as TypedDocumentString<GameCardDataFragment, unknown>;
...
export const GetGamesForInfiniteScrollDocument = new TypedDocumentString(`
  ...
  latestResult {
	...
	GetGamesForInfiniteScrollQuery,
	GetGamesForInfiniteScrollQueryVariables
>;
