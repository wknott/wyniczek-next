...
const documents: Documents = {
    ...
    "query GetGamesMainView($sortBy: GameSortBy = LAST_PLAYED) {\n  games(skip: 0, take: 200, sortBy: $sortBy) {\n    items {\n      id\n      name\n      thumbnailUrl\n      bggRank\n      avgPlayingTime2Players\n      lastPlayedAt\n      inCollection\n      resultsCount\n      latestResult {\n        id\n        createdAt\n        playingTime\n        scores {\n          player {\n            id\n            name\n          }\n        }\n      }\n    }\n    total\n  }\n}": types.GetGamesMainViewDocument,
    ...
    "mutation UpdateGameManualUrl($id: String!, $url: String) {\n  updateGameManualUrl(id: $id, url: $url) {\n    id\n    manualUrl\n  }\n}": types.UpdateGameManualUrlDocument,
};
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetGamesMainView($sortBy: GameSortBy = LAST_PLAYED) {\n  games(skip: 0, take: 200, sortBy: $sortBy) {\n    items {\n      id\n      name\n      thumbnailUrl\n      bggRank\n      avgPlayingTime2Players\n      lastPlayedAt\n      inCollection\n      resultsCount\n      latestResult {\n        id\n        createdAt\n        playingTime\n        scores {\n          player {\n            id\n            name\n          }\n        }\n      }\n    }\n    total\n  }\n}"): typeof import('./graphql').GetGamesMainViewDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetPlayerById($id: String!) {\n  player(id: $id) {\n    id\n    name\n    records {\n      totalPoints\n      createdAt\n      resultId\n      game {\n        id\n        name\n        thumbnailUrl\n      }\n      expansions {\n        id\n        name\n      }\n    }\n  }\n}"): typeof import('./graphql').GetPlayerByIdDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation UpdateGameManualUrl($id: String!, $url: String) {\n  updateGameManualUrl(id: $id, url: $url) {\n    id\n    manualUrl\n  }\n}"): typeof import('./graphql').UpdateGameManualUrlDocument;
